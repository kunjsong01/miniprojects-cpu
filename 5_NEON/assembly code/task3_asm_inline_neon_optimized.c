...
void matrix_multiply_asm_neon()
{
    ...
    "K_LOOP:"                           "\n\t"
        ...
        "vadd.i32 q8, q8, q9"           "\n\t" // q8 <- q8 + q9
        "vadd.i32 q8, q8, q10"          "\n\t" // q8 <- q8 + q10, q8 to hold results of first 16 elements
                                    // loop unroll once
        "vld1.64 {d0-d3}, [r6:64]!"    "\n\t" // load next first 8 elements from A's target row and increment addr
        "vld1.64 {d4-d7}, [r7:64]!"    "\n\t" // load next first 8 elements from B's target row and increment addr
        "vld1.64 {d8-d11}, [r6:64]!"   "\n\t" // load next second 8 elements from A's target row and increment addr 
        "vld1.64 {d12-d15}, [r7:64]!"  "\n\t" // load next second 8 elements from B's target row and increment addr
                                    // loop unroll once, do vector multiplication
        "vmul.i32 q12, q0, q4"          "\n\t" // q12 <- q0 * q4
        "vmul.i32 q9, q1, q5"          "\n\t" // q9 <- q1 * q5
        "vmul.i32 q10, q2, q6"         "\n\t" // q10 <- q2 * q6
        "vmul.i32 q11, q3, q7"         "\n\t" // q11 <- q3 * q7
        ...
        "vadd.i32 q10, q10, q11"        "\n\t" // q10 <- q10 + q11
        "vadd.i32 q12, q12, q9"         "\n\t" // q12 <- q12 + q9
        "vadd.i32 q12, q12, q10"        "\n\t" // q12 <- q12 + q10, q8 to hold results of next 16 elements
                                    // add q8 and q12
        "vadd.i32 q8, q8, q12"        "\n\t" // q8 <- q12 + q8, q8 now holds the results of 32 elements 
        "vadd.i32 d16, d16, d17"        "\n\t" // reduce within q8
        "vpadd.i32 d16, d16"            "\n\t" // reduce within d16 in q8, reduce d16 to least signft of d16
        "subs r2, r2, #1"                "\n\t" // k--, auto checking k > 0
        "bne K_LOOP"                    "\n\t" //  go to next iteration if K > 0 
